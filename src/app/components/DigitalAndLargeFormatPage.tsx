...
const digitalAndLargeFormatSampleImages = Object.entries(import.meta.glob('/src/assets/images/digitalAndLargeFormat/samples/*.{png,jpg,jpeg}', { eager: true }) as Record<string, { default: string }> )
...
export function DigitalAndLargeFormatPage({ items, onBack, initialSelectedItemTitle }: DigitalAndLargeFormatPageProps) {
  return (
    <CategoryPage
      ...
      sampleImages={digitalAndLargeFormatSampleImages}
